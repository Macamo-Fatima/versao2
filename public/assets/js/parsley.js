...
(function (global, factory) {
    ...
    var Utils = {
        ...
        parseRequirement: function parseRequirement(requirementType, string) {
            ...
            if (!converter)
                throw (
                    'Unknown requirement specification: "' +
                    requirementType +
                    '"'
                );
        ...
        all: function all(promises) {
            ...
            return $.when.apply(
                $,
                _toConsumableArray(promises).concat([42, 42])
            );
        },
    ...
    var comparisonOperator = function comparisonOperator(operator) {
        return {
            ...
            requirementType:
                operator.length <= 2 ? "string" : ["string", "string"],
    ...
    UI.Field = {
        ...
        addError: function addError(name) {
            var _ref =
                ...
                updateClass =
                    _ref$updateClass === void 0 ? true : _ref$updateClass;
        ...
        updateError: function updateError(name) {
            var _ref2 =
                ...
                updateClass =
                    _ref2$updateClass === void 0 ? true : _ref2$updateClass;
        ...
        removeError: function removeError(name) {
            var _ref3 =
                ...
                updateClass =
                    _ref3$updateClass === void 0 ? true : _ref3$updateClass;
        ...
        _getErrorMessage: function _getErrorMessage(constraint) {
            ...
            if (
                "undefined" !==
                typeof this.options[customConstraintErrorMessage]
            )
        ...
        _insertErrorWrapper: function _insertErrorWrapper() {
            ...
            if (
                "object" === _typeof($errorsContainer) &&
                $errorsContainer.length
            )
                return $errorsContainer.append(this._ui.$errorsWrapper);
    ...
    Form.prototype = {
        onSubmitValidate: function onSubmitValidate(event) {
            ...
            if (
                submitSource &&
                null !== submitSource.getAttribute("formnovalidate")
            )
                return;
            ...
            this._withoutReactualizingFormOptions(function () {
                _this4.$element
                    ...
                    .each(function (_, element) {
                        var fieldInstance = new window.Parsley.Factory(
                            element,
                            {},
                            _this4
                        ...
                        if (
                            ...
                            var uniqueId =
                                fieldInstance.__class__ +
                                "-" +
                                fieldInstance.__id__;

                            if (
                                "undefined" ===
                                typeof _this4.fieldsMappedById[uniqueId]
                            ) {
                                _this4.fieldsMappedById[uniqueId] =
                                    fieldInstance;
                ...
                $.each(
                    Utils.difference(oldFields, _this4.fields),
                    function (_, field) {
                        field.reset();
                    }
                );
        ...
        _withoutReactualizingFormOptions:
            function _withoutReactualizingFormOptions(fn) {
    ...
    Constraint.prototype = {
        validate: function validate(value, instance) {
            ...
            return (_this$validator = this.validator).validate.apply(
                _this$validator,
                [value].concat(_toConsumableArray(this.requirementList), [
                    instance,
                ])
            );
        },
        ...
        _validateConstraint: function _validateConstraint(value, constraint) {
            ...
            return Utils.all([result]).fail(function (errorMessage) {
                ...
                _this3.validationResult.push({
                    assert: constraint,
                    errorMessage:
                        "string" === typeof errorMessage && errorMessage,
                });
            });
        },
        ...
        _bindConstraints: function _bindConstraints() {
            ...
            for (var i = 0; i < this.constraints.length; i++) {
                if (false === this.constraints[i].isDomConstraint) {
                    ...
                    constraintsByName[this.constraints[i].name] =
                        this.constraints[i];
                }
            }
    ...
    Factory.prototype = {
        ...
        handleMultiple: function handleMultiple() {
            ...
            for (var i = 0; i < $previouslyRelated.length; i++) {
                parsleyMultipleInstance = $($previouslyRelated.get(i)).data(
                    "Parsley"
                );
    ...
    $.emit = function (name, instance) {
        ...
        deprecated();
        var instanceGiven =
            instance instanceof Field || instance instanceof Form;
    ...
    Parsley.addValidator("remote", {
        ...
        validateString: function validateString(value, url, options, instance) {
            ...
            var validator =
                options.validator ||
                (true === options.reverse ? "reverse" : "default");
    ...
    Parsley.addMessages("en", {
        defaultMessage: "Este valor parece inválido.",
        type: {
            email: "Por favor digite um email válido.",
            url: "Por favor digite uma URL válida.",
            number: "Aceite apenas números.",
            integer: "Aceite apenas valores inteiros.",
            digits: "Aceite apenas dígitos.",
            alphanum: "Aceite apenas valores alfanuméricos.",
        },
        ...
        minlength:
            "Este valor não atinge o mínimo. Deve ter %s caracteres ou mais.",
        maxlength:
            "Este valor excede o definido. Deve ter %s caracteres ou menos.",
        length: "Este tamanho é inválido. Deve estar entre %s e %s caracteres longos.",
        ...
        euvatin: "Não é número de identificação válido de IVA.",
    });
    ...
    function InputEvent() {
        ...
        _extends(this, {
            ...
            isNativeEvent: function isNativeEvent(evt) {
                return (
                    evt.originalEvent && evt.originalEvent.isTrusted !== false
                );
            },
