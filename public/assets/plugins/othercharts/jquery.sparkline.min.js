    ...
    (function (factory) {
        ...
        quartile = function (values, q) {
            ...
            if (q === 2) {
                ...
                if (values.length % 2) {
                    ...
                    return vl % 1
                        ? (values[Math.floor(vl)] +
                              values[Math.floor(vl) - 1]) /
                              2
                        : values[vl - 1];
                } else {
        ...
        Tooltip = createClass({
            ...
            init: function (options) {
                var tooltipClassname = options.get(
                        "tooltipClassname",
                        "jqstooltip"
                    ),
                ...
                render = function () {
                    ...
                    width =
                        options.get("width") === "auto"
                            ? values.length *
                              options.get("defaultPixelsPerValue")
                            : options.get("width");
                ...
                if (lighten) {
                    ...
                    if (parse) {
                        ...
                        for (i = 0; i < 3; i++) {
                            rgbnew[i] = clipval(
                                Math.round(
                                    parseInt(parse[i + 1], 16) * mult * lighten
                                ),
                                0,
                                255
                            );
        ...
        $.fn.sparkline.line = line = createClass($.fn.sparkline._base, {
            ...
            render: function () {
                ...
                rangex =
                    this.maxx - this.minx === 0 ? 1 : this.maxx - this.minx;
                rangey =
                    this.maxy - this.miny === 0 ? 1 : this.maxy - this.miny;
                yvallast = this.yvalues.length - 1;
                if (
                    spotRadius &&
                    (canvasWidth < spotRadius * 4 ||
                        canvasHeight < spotRadius * 4)
                ) {
                    spotRadius = 0;
                }
                if (spotRadius) {
        ...
        $.fn.sparkline.bar = bar = createClass(
            ...
            barHighlightMixin,
            {
                ...
                calcColor: function (stacknum, value, valuenum) {
                    ...
                    if (
                        colorMapByValue &&
                        (newColor = colorMapByValue.get(value))
                    ) {
                        color = newColor;
                    } else if (
                        colorMapByIndex &&
        ...
        $.fn.sparkline.bullet = bullet = createClass($.fn.sparkline._base, {
            ...
            init: function (el, values, options, width, height) {
                ...
                this.regiondata = {};
                this.width = width =
                    options.get("width") === "auto" ? "4.0em" : width;
                this.target = this.$el.simpledraw(
                    width,
                    height,
                    options.get("composite")
