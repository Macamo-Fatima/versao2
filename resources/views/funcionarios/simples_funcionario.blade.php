    ...
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#"><i class="fe fe-users mr-2 fs-14"></i>Colaboradoes</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span class="font-weight-bold"><i class="mdi mdi-account-edit mr-1"></i> Colaboradoes</span>
                ...
                <div class="card-body">
                    <form action="{{route('update/funcionario')}}" method="POST" enctype="multipart/form-data" id="validate">
                        @csrf
                            ...
                            <div class="panel-body tabs-menu-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <input type="hidden" class="form-control" name="documento_antigo" value="{{$dados[0]->tipo_documento}}" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select class="form-control custom-select select2" name="funcao" id="funcao" required>
                                                            <option value="{{$dados[0]->funcao}}"> {{$dados[0]->nome_cargo}}</option>
                                    ...
                                    <div class="tab-pane" id="tab14">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <input type="hidden" class="form-control" name="doenca_antiga" value="{{$dados[0]->doencas_cronicas}}">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="hidden" class="form-control" name="alergia_antiga" value="{{$dados[0]->deficiencias_alergias}}">
                        ...
                        <div class="modal-footer">
                            <a href="{{route('apenas/funcionarios')}}" class="btn btn-secondary btn-sm">
